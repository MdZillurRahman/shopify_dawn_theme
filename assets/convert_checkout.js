...
if (typeof _conv_host == 'undefined') {
  ...
  const isInjected = Array.prototype.slice.apply(document.getElementsByTagName('script')).some(el => el.src.includes('cdn-4.convertexperiments.com/js/1004908-1004832.js'));
  if (!isInjected) {
